...
US: { currency: 'USD', locale: 'en-US', symbol: 'latex
' }, GB: { currency: 'GBP', locale: 'en-GB', symbol: '£' }, AE: { currency: 'AED', locale: 'ar-AE', symbol: 'د.إ' }, DEFAULT: { currency: 'USD', locale: 'en-US', symbol: '
