  ...
  return (
    <section className="relative mx-auto mt-20 max-w-6xl border-t border-white/10 pt-10" aria-labelledby="related-products-title">
      <div className="mb-7 flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
        ...
        <Link href="/#catalog" className="liquid-ui hadx-tap-reactive inline-flex w-fit items-center rounded-full border border-white/15 px-4 py-2 text-[10px] font-mono uppercase tracking-[0.2em] text-zinc-400 transition-colors hover:border-amber-200/60 hover:text-amber-100">Open full archive ↗</Link>
      </div>
          ...
          {products.map((product, index) => {
            ...
            return (
              <Link
                ...
                className="liquid-ui hadx-tap-reactive hadx-premium-card group relative overflow-hidden rounded-2xl border border-white/10 bg-black/20 p-3 transition-all duration-300 hover:-translate-y-1 hover:border-amber-200/50 hover:bg-white/[0.06]"
