  ...
  return (
    <main className="relative min-h-screen bg-transparent text-zinc-100 pt-32 pb-24 px-6">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12">
        <div className="space-y-4"><ProductVariantExperience productId={product.id} sku={product.sku} name={product.title} price={amount} currency={currency} imageUrl={parsed.media.find((media) => media.type === "image")?.url || product.imageUrl || null} media={parsed.media} availableSizes={parsed.availableSizes} stockBySize={parsed.stockBySize} colorVariants={parsed.colorVariants} /><div data-liquid-surface className="liquid-panel product-detail-glass flex flex-col rounded-2xl p-6">
